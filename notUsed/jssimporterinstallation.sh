...
# If you choose to hardcode API information into the script, uncomment the lines below and set one or more of the following values:
#
...
# 
# In normal usage, this is sufficient to get access to the distribution point information stored in the Jamf Pro server.
...
# If you're using a Jamf Pro cloud distribution point as your master distribution point, the cloud_distribution_point variable should look like this:
#
