...
sudo rm -rf /Applications/Google Chrome.app/Contents/Frameworks/Google Chrome Framework.framework/Versions/80.0.3987.116
sudo rm -rf /Applications/Google Chrome.app/Contents/Frameworks/Google Chrome Framework.framework/Versions/80.0.3987.106
...
echo "Now we will reinstall a stable version of Google Chrome for you, hang tight"
sudo jamf policy -event installChromeStable
sudo jamf recon
